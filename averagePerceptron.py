...
def trainAveragePerceptron(max_epoch, r):
...
def testAveragePerceptron(weight):
    # Grab the training data (code recycled from the Decision Tree Project
    trainingData, testingData = getPerceptron_Data();
...
if __name__ == "__main__":
    max_epoch = 10
    r = 0.1
    averagePerceptronWeights = trainAveragePerceptron(max_epoch, r)
    averagePerceptronAccuracy = testAveragePerceptron(averagePerceptronWeights)
    print "Average Perceptron Weight: " + str(averagePerceptronWeights)
    print "Accuracy in testing: " + str(averagePerceptronAccuracy)